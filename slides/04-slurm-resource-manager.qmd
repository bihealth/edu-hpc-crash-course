...
- start interactive job with `srun`
  ...
  - [--time=2:00:00]{.fragment .highlight-red} makes your job run up to two hours
  - [--partition=short]{.fragment .highlight-red} submits into the **short** partition
  - [--reservation=hpc-crash-course]{.fragment .highlight-red} submits into the **hpc-crash-course** reservation
